# -*- coding: utf-8 -*-
'''
Entrada:Numero random (secreto)
Proceso: tirar numero para adivinarlo. hasta 3 veces. Si acierto ganamos (termina). Si no acierto ( intento hasta 3 veces)
Salida- Informar si gano o no
'''
import random # Genera un número aleatorio entre 1 y 10
numero_secreto = random.randint(1, 10)
print(numero_secreto)
gano=False
for(i) in range(1,4,1):
    print(f"Intento {i}/3")
    miapuesta=int(input("Ingrese su apuesta"))
    if miapuesta==numero_secreto:
        print("Gano")
        gano = True
        break
    else:
...
if i==3 and gano==False:
    print("Agoto sus intentos")
